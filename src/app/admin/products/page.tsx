...
import { Heading, SimpleGrid, Box, Link, Text, Image, Stack } from "@chakra-ui/react";
  ...
  return (
    <Box paddingX={{ base: "2rem", md: "10rem" }} paddingY="5rem">
      ...
      >
        ...
        <Link as={NextLink} href="/admin/products/create" fontSize="xl">Create New Product</Link>
      </Stack>
      <SimpleGrid
